    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        checkoutButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (time == -1) {
                    Toast.makeText(getApplicationContext(), "Не выбрано ни одного блюда", Toast.LENGTH_LONG).show();
                } else {
                    Intent i = new Intent(MenuActivity.this, TimerActivity.class);
                    i.putExtra("timer", time);
                    Toast.makeText(getApplicationContext(), "Спасибо, мы готовим ваш заказ!", Toast.LENGTH_LONG).show();
                    startActivity(i);
                    finish();
